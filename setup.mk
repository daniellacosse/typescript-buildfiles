...
$(PROXY_FOLDER)/Brewfile: $(PROXY_FOLDER) Brewfile
	brew bundle --force \
		> $(PROXY_FOLDER)/Brewfile

Brewfile: # watch this file

$(PROXY_FOLDER)/yarn.lock: $(PROXY_FOLDER) yarn.lock
	yarn install \
		> $(PROXY_FOLDER)/yarn.lock

yarn.lock: # watch this file

$(PROXY_FOLDER)/vscode-extensions.json: $(PROXY_FOLDER) .vscode/extensions.json
